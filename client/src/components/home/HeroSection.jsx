...
const HeroSection = () => {
  ...
  return (
    <div className="w-full relative h-screen overflow-hidden">
      ...
      />
      <div className="absolute w-full flex flex-col items-center mt-8 sm:mt-12 md:mt-16 px-4">
        <h2
        ...
        <Link to={user ? "/workspace" : "/login"} className="mt-6 sm:mt-8">
          <Button
            className="font-jersey text-lg sm:text-xl md:text-2xl lg:text-3xl p-4 sm:p-5 md:p-6"
            variant={"pixel"}
          >
