    ...
    <div className="bg-white dark:bg-[#1a1730] rounded-[2rem] p-6 border border-zinc-300 dark:border-zinc-700 border-b-4 shadow-sm w-full max-w-[340px]">
      ...
      <div className="flex justify-between px-0.5">
        {days.map((day, idx) => (
          <div
            key={idx}
            className="flex flex-col items-center gap-1.5 animate-in fade-in slide-in-from-bottom-2 duration-300"
              ...
              <div
                className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-colors ${
                  day.isActive
                    ...
                    : "border-zinc-100 dark:border-zinc-700 bg-transparent"
                }`}
              >
                <Zap
