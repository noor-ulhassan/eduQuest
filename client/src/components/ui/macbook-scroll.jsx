  ...
  return (
    <div ref={ref} className="relative min-h-[200vh]">
      ...
      <div className="sticky top-0 h-0 overflow-visible pointer-events-none hidden lg:block">
        {/* Left */}
        <div className="absolute left-10 xl:left-20 top-[50vh] -translate-y-1/2 w-56 xl:w-64">
        ...
        {/* Right */}
        <div className="absolute right-10 xl:right-20 top-[50vh] -translate-y-1/2 w-48 xl:w-56">
