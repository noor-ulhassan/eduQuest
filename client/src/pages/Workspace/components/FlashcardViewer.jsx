  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute left-8 p-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
      >
      ...
      <button
        ...
        className="absolute right-8 p-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
      >
      ...
      >
        ...
        >
          {/* Front Face */}
          <div
            className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#8c2bee] to-[#6b1fb8] p-10 flex flex-col items-center justify-center text-center shadow-2xl shadow-[#8c2bee]/30"
