...
function ProgressCard({ course, progress }) {
 ...
 return (
  <div className="shadow-md rounded-xl border flex flex-col h-full bg-[#111111] hover:shadow-lg transition-all cursor-pointer overflow-hidden">
   {/* Added 'bg-white/5' so the card doesn't look empty if the GIF is loading */}
   ...
   <div className="p-4 flex flex-col gap-3 flex-grow">
    ...
    {progress !== undefined && (
     <div className="mt-2">
      ...
      <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden border">
       <div
     ...
     <div className="flex gap-2">
      {progress !== undefined ? (
       <Button
        ...
        variant={"pixel"}
        className="flex items-center gap-2 h-9 font-jersey text-xl bg-red-600 hover:bg-red-500"
       >
