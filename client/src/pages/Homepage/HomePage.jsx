    ...
    <div className={`min-h-screen ${user ? "dark bg-[#0f0f0f]" : "bg-white"}`}>
      {user ? (
        <main className="relative flex-grow w-full pb-12 sm:pb-16 overflow-hidden">
          ...
          />
          {/* Greeting */}
          <div className="relative z-10 max-w-[1350px] mx-auto px-4 sm:px-6 pt-4 pb-1">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-metallic mb-5">
              {greeting},{" "}
          ...
          {/* Stats + Cards */}
          <div className="relative z-10 max-w-[1350px] mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-center gap-6 lg:gap-8 px-4 sm:px-6 mt-3">
            {/* Left Column */}
            <div className="w-full lg:w-auto flex flex-col gap-6 items-center lg:items-start shrink-0">
              <div className="w-full max-w-[340px] space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-[#111] border border-yellow-500/25 text-sm font-black hover:border-yellow-500/50 transition-colors"
                >
                  <span className="flex items-center gap-2 text-metallic">
                    <img src="/swordgold.png" alt="" width={30} height={30} />
                    Leaderboard
                  </span>
                  <span className="text-metallic-orange text-sm">→</span>
                </button>
              </div>
            </div>

            {/* Center Column */}
            <div className="w-full lg:w-auto flex justify-center overflow-x-hidden shrink-0">
              <DraggableCards />
            </div>
        ...
        <>
          ...
          <div className="bg-[#0f0f0f] py-20 px-4 sm:px-8">
            <div className="max-w-5xl mx-auto mb-12 text-center">
              <p className="text-[10px] font-inter font-bold uppercase tracking-widest text-metallic-orange mb-3">
                How It Works
              </p>
              <h2 className="text-3xl sm:text-4xl font-inter font-bold text-metallic leading-tight">
                From zero to leaderboard.
                <br />
                ...
                content={[
                  {
                    ...
                    description:
                      "Choose from 9 languages — Python, JavaScript, Java, C, C++, TypeScript, React, HTML, CSS. Every environment is pre-configured. No setup. No npm install. Just code.",
                    ...
                    content: (
                      <div className="flex flex-col items-center justify-center h-full gap-3 p-6">
                        {[
                          ...
                          <div
                            key={lang}
                            className="w-full flex items-center justify-between px-4 py-2 rounded-lg bg-white/5 border border-white/8"
                          >
                            <span className="font-inter text-sm font-semibold text-metallic">
                              {lang}
                            </span>
                            <span className="text-[10px] font-inter text-metallic-orange uppercase tracking-widest">
                              {i < 3 ? "Available" : "+ More"}
                            </span>
                          </div>
                        ))}
                  ...
                  },
                  {
                    ...
                    description:
                      "Real challenges. Real test cases. The editor runs your code against hidden inputs and tells you exactly what failed. Fix it. Resubmit. Repeat. That's how you actually improve.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Every solved challenge earns XP. XP builds rank. Rank unlocks harder problems. The ladder goes: Bronze → Silver → Gold → Grandmaster. Each tier is a proof of skill, not time spent.",
                    badge: "Step 03 — Rank",
                    content: (
                      <div className="flex flex-col justify-center h-full p-6 gap-4">
                        {[
                          ["Grandmaster", "#f97316", "95%"],
                          ["Gold", "#eab308", "72%"],
                          ["Silver", "#94a3b8", "48%"],
                          ["Bronze", "#b45309", "25%"],
                        ].map(([tier, color, w]) => (
                  ...
                  },
                  {
                    ...
                    description:
                      "Enter a live room with a code and face another developer head-to-head. Same problem, same timer. First to pass all test cases wins. Voice chat included. No excuses.",
                    ...
                    content: (
                      <div className="flex flex-col justify-center h-full p-6 gap-5">
                        ...
                        {[
                          ["You", 75, "bg-orange-500"],
                          ["Opponent", 43, "bg-blue-500"],
                        ].map(([name, pct, cls]) => (
                          <div key={name}>
                            ...
                            <div className="w-full bg-white/5 rounded-full h-2">
                              <div
                                className={`${cls} h-2 rounded-full transition-all duration-700`}
                                style={{ width: `${pct}%` }}
                              />
                            </div>
                          </div>
                        ))}
                        <p className="text-[10px] font-inter text-metallic-orange uppercase tracking-widest">
                          You&apos;re ahead — close it out.
                        </p>
                      </div>
                    ),
                  },
