  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold font-jersey text-zinc-800">
            Knowledge Vault
          </h1>
          <p className="text-sm sm:text-base text-zinc-500">
            Manage your PDFs and generate AI quizzes.
          </p>
        </div>
        <Button
          ...
          {documents.map((doc) => (
            ...
            >
              ...
              <CardContent className="p-5 flex-grow bg-white">
                <h3 className="font-bold text-lg truncate mb-2 text-zinc-800">
                  {doc.title}
                </h3>
      ...
      <Dialog open={isUploadOpen} onOpenChange={setIsUploadOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold font-jersey">
